...
const eventPresentationPdf = "/apresentacao_seguro_eventos__atual.pdf";
...
const services: Service[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=1400&q=88",
    icon: Users,
    color: "text-cyan",
    bgIcon: "bg-cyan",
